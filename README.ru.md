...
| **Мобильная станция команд** | [`mobile-app/`](./mobile-app/) клиент uni-app (WeChat mini program / Android / iOS / H5): выбор проектов, отправка batch-команд, отслеживание прогресса; WeChat login/оплата; переход в Web для детального редактирования |
...
**Мобильная станция команд ([`mobile-app/`](./mobile-app/)):** лёгкий **мобильный компаньон** Web-рабочего стола — выбор проекта, отправка batch-команд Цифрового писателя/режиссёра и мониторинг прогресса с телефона. Редактирование глав, раскадровка и mux остаются в Web (`workbench`). Одна кодовая база uni-app для WeChat mini program, Android, iOS и H5 (dev `:48555`).
...
| Мобильный — проекты | Мобильный — задачи |
|:---:|:---:|
| ![Мобильная станция команд — список проектов](./workbench-data/images/mobile-project.jpg) | ![Мобильная станция команд — прогресс batch job](./workbench-data/images/mobile-task.jpg) |
