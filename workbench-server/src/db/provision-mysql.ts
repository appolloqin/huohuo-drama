...
async function bootstrapBuiltinAiProviders(pool: Pool) {
  ...
  const rows = [
    ...
    {
      name: 'minimax-h3',
      displayName: 'MiniMax H3 视频',
      serviceType: 'video',
      provider: 'minimax-h3',
      defaultUrl: 'https://api.minimaxi.com',
      presetModels: ['MiniMax-H3'],
      description: 'MiniMax-H3 /v2/video_generation',
    },
    {
      name: 'comfyui-t2i',
      displayName: 'ComfyUI 文生图',
      serviceType: 'image',
      provider: 'comfyui-t2i',
      defaultUrl: 'http://127.0.0.1:8188',
      presetModels: ['comfyui-t2i'],
      description: 'ComfyUI /prompt + /history',
    },
    {
      name: 'comfyui-i2i',
      displayName: 'ComfyUI 图生图',
      serviceType: 'image',
      provider: 'comfyui-i2i',
      defaultUrl: 'http://127.0.0.1:8188',
      presetModels: ['comfyui-i2i'],
      description: 'ComfyUI /prompt + /history',
    },
    {
      name: 'comfyui-t2v',
      displayName: 'ComfyUI 文生视频',
      serviceType: 'video',
      provider: 'comfyui-t2v',
      defaultUrl: 'http://127.0.0.1:8188',
      presetModels: ['comfyui-t2v'],
      description: 'ComfyUI /prompt + /history',
    },
    {
      name: 'comfyui-i2v',
      displayName: 'ComfyUI 图生视频',
      serviceType: 'video',
      provider: 'comfyui-i2v',
      defaultUrl: 'http://127.0.0.1:8188',
      presetModels: ['comfyui-i2v'],
      description: 'ComfyUI /prompt + /history',
    },
    {
      name: 'minimax-audio',
